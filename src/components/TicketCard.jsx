...
const CheckCircleIcon = () => <svg xmlns="http://www.w.org/2000/svg" className="h-4 w-4 mr-1.5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>;
        ...
        <div className="text-xs opacity-0 animate-fade-in-up [animation-delay:150ms]">
          ...
          {showAddToKbButton && (
            <div className="mt-4 flex justify-end">
              ...
              >
                {isSubmitted ? (
                  <><CheckCircleIcon /> Решение добавлено в БЗ</>
                ) : (
