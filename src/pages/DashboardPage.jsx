...
function DashboardPage() {
  return (
    <main className="p-6">
      <header className="flex justify-between items-center mb-6 mx-6">
        <h1 className="text-2xl font-bold text-white">Дашборд автоматизации поддержки</h1>
        <button className="bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2 rounded-lg font-semibold shadow-lg shadow-indigo-500/20 transform transition-transform hover:scale-105 active:scale-95">
